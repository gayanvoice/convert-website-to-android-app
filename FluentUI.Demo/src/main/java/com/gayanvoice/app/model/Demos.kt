...
package com.gayanvoice.app.model

import com.gayanvoice.app.component.activity.*
import java.util.*
...
data class Demo(val title: String, val demoClass: KClass<out com.gayanvoice.app.AppActivity>) {
